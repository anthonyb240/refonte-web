...
--
-- Client :  localhost
-- Généré le :  Jeu 05 Décembre 2024 à 16:55
...
`id` int(11) NOT NULL,
  ...
  `presentation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
...
INSERT INTO `membres` (`id`, `nom`, `email`, `date`, `formation`, `photo`, `presentation`) VALUES
...
CREATE TABLE IF NOT EXISTS `membre_competences` (
`id` int(11) NOT NULL,
